  ...
  <footer class="footer">
    <div class="container">
      <div class="footer-main">
        ...
        <a href="http://10.168.4.20:8099/mti-gis/mtigisapi.git" class="footer-main-link" target="_blank">{{ langConfig.repo }}</a>
        <a href="#" class="footer-main-link" target="_blank">{{ langConfig.changelog }}</a>
        <a href="#" class="footer-main-link" target="_blank">{{ langConfig.faq }}</a>
      </div>
      <div class="footer-main">
        <h4>{{ langConfig.community }}</h4>
        <a :href="gitterLink" class="footer-main-link" target="_blank">{{ langConfig.gitter }}</a>
        <a href="#" class="footer-main-link" target="_blank">{{ langConfig.feedback }}</a>
        <a href="#" class="footer-main-link" target="_blank">{{ langConfig.contribution }}</a>
      </div>
      <div class="footer-social">
        <p class="footer-social-title">about MTIGIS 2.0</p>
        <!-- <el-popover
          ref="weixin"
          placement="top"
          width="120"
        ...
        <a href="http://10.168.4.20:8099/mti-gis/mtigisapi.git" target="_blank">
